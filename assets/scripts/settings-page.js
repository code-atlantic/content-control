...
(function (factory) {
    ...
    var S2 =
        (function () {
            ...
            if (jQuery && jQuery.fn && jQuery.fn.jpselect2 && jQuery.fn.jpselect2.amd) {
                var S2 = jQuery.fn.jpselect2.amd;
            }
...
//be followed.
            ...
            S2.define('jpselect2/results',[
                ...
                Results.prototype.render = function () {
                    var $results = $(
                        '<ul class="jpselect2-results__options" role="tree"></ul>'
                    );
                ...
                Results.prototype.displayMessage = function (params) {
                    ...
                    var $message = $(
                        ...
                        ' class="jpselect2-results__option"></li>'
                    );
                    ...
                    $message[0].className += ' jpselect2-results__message';

                    this.$results.append($message);
                };

                Results.prototype.hideMessages = function () {
                    this.$results.find('.jpselect2-results__message').remove();
                };
                ...
                Results.prototype.position = function ($results, $dropdown) {
                    var $resultsContainer = $dropdown.find('.jpselect2-results');
                ...
                Results.prototype.setClasses = function () {
                    ...
                    this.data.current(function (selected) {
                        ...
                        var $options = self.$results
                            .find('.jpselect2-results__option[aria-selected]');
                ...
                Results.prototype.option = function (data) {
                    ...
                    option.className = 'jpselect2-results__option';
                    ...
                    if (data.children) {
                        ...
                        label.className = 'jpselect2-results__group';
                        ...
                        var $childrenContainer = $('<ul></ul>', {
                            'class': 'jpselect2-results__options jpselect2-results__options--nested'
                        });
                ...
                Results.prototype.bind = function (container, $container) {
                    ...
                    container.on('results:focus', function (params) {
                        params.element.addClass('jpselect2-results__option--highlighted');
                    });
                    ...
                    this.$results.on('mouseup', '.jpselect2-results__option[aria-selected]',
                        function (evt) {
                            var $this = $(this);
                    ...
                    this.$results.on('mouseenter', '.jpselect2-results__option[aria-selected]',
                        function (evt) {
                            var data = $(this).data('data');

                            self.getHighlightedResults()
                                .removeClass('jpselect2-results__option--highlighted');
                ...
                Results.prototype.getHighlightedResults = function () {
                    var $highlighted = this.$results
                        .find('.jpselect2-results__option--highlighted');
            ...
            S2.define('jpselect2/selection/base',[
                'jquery',
                '../utils',
                '../keys'
            ], function ($, Utils, KEYS) {
                ...
                BaseSelection.prototype.render = function () {
                    var $selection = $(
                        '<span class="jpselect2-selection" role="combobox" ' +
                ...
                BaseSelection.prototype._attachCloseHandler = function (container) {
                    ...
                    $(document.body).on('mousedown.jpselect2.' + container.id, function (e) {
                        var $target = $(e.target);

                        var $select = $target.closest('.jpselect2');

                        var $all = $('.jpselect2.jpselect2-container--open');
                        ...
                        $all.each(function () {
                            ...
                            $element.jpselect2('close');
                        });
                    });
                };

                BaseSelection.prototype._detachCloseHandler = function (container) {
                    $(document.body).off('mousedown.jpselect2.' + container.id);
                };
            ...
            S2.define('jpselect2/selection/single',[
                'jquery',
                './base',
                '../utils',
                '../keys'
                ...
                SingleSelection.prototype.render = function () {
                    ...
                    $selection.addClass('jpselect2-selection--single');

                    $selection.html(
                        '<span class="jpselect2-selection__rendered"></span>' +
                        '<span class="jpselect2-selection__arrow" role="presentation">' +
                ...
                SingleSelection.prototype.bind = function (container, $container) {
                    ...
                    this.$selection.find('.jpselect2-selection__rendered').attr('id', id);
                ...
                SingleSelection.prototype.clear = function () {
                    this.$selection.find('.jpselect2-selection__rendered').empty();
                };
                ...
                SingleSelection.prototype.update = function (data) {
                    ...
                    var $rendered = this.$selection.find('.jpselect2-selection__rendered');
            ...
            S2.define('jpselect2/selection/multiple',[
                'jquery',
                './base',
                '../utils'
                ...
                MultipleSelection.prototype.render = function () {
                    ...
                    $selection.addClass('jpselect2-selection--multiple');

                    $selection.html(
                        '<ul class="jpselect2-selection__rendered"></ul>'
                    );
                ...
                MultipleSelection.prototype.selectionContainer = function () {
                    var $container = $(
                        '<li class="jpselect2-selection__choice">' +
                        '<span class="jpselect2-selection__choice__remove" role="presentation">' +
                        '&times;' +
                        '</span>' +
                        '</li>'
                    );
            ...
            S2.define('jpselect2/selection/placeholder',[
                '../utils'
            ], function (Utils) {
                ...
                Placeholder.prototype.createPlaceholder = function (decorated, placeholder) {
                    ...
                    $placeholder.addClass('jpselect2-selection__placeholder')
                        .removeClass('jpselect2-selection__choice');
                ...
                Placeholder.prototype.update = function (decorated, data) {
                    ...
                    this.$selection.find('.jpselect2-selection__rendered').append($placeholder);
                };

                return Placeholder;
            });

            S2.define('jpselect2/selection/allowClear',[
                'jquery',
                '../keys'
            ], function ($, KEYS) {
                function AllowClear () { }
                ...
                AllowClear.prototype.bind = function (decorated, container, $container) {
                    ...
                    this.$selection.on('mousedown', '.jpselect2-selection__clear',
                        function (evt) {
                ...
                AllowClear.prototype._handleClear = function (_, evt) {
                    ...
                    var $clear = this.$selection.find('.jpselect2-selection__clear');
                ...
                AllowClear.prototype.update = function (decorated, data) {
                    ...
                    if (this.$selection.find('.jpselect2-selection__placeholder').length > 0 ||
                        data.length === 0) {
                        return;
                    }

                    var $remove = $(
                        '<span class="jpselect2-selection__clear">' +
                        '&times;' +
                        '</span>'
                    );
                    $remove.data('data', data);

                    this.$selection.find('.jpselect2-selection__rendered').prepend($remove);
                };

                return AllowClear;
            });

            S2.define('jpselect2/selection/search',[
                'jquery',
                '../utils',
                '../keys'
            ], function ($, Utils, KEYS) {
                ...
                Search.prototype.render = function (decorated) {
                    var $search = $(
                        '<li class="jpselect2-search jpselect2-search--inline">' +
                        '<input class="jpselect2-search__field" type="search" tabindex="-1"' +
                ...
                Search.prototype.bind = function (decorated, container, $container) {
                    ...
                    this.$selection.on('focusin', '.jpselect2-search--inline', function (evt) {
                        self.trigger('focus', evt);
                    });

                    this.$selection.on('focusout', '.jpselect2-search--inline', function (evt) {
                        self._handleBlur(evt);
                    });

                    this.$selection.on('keydown', '.jpselect2-search--inline', function (evt) {
                        evt.stopPropagation();
                        ...
                        if (key === KEYS.BACKSPACE && self.$search.val() === '') {
                            var $previousChoice = self.$searchContainer
                                .prev('.jpselect2-selection__choice');
                ...
                Search.prototype.update = function (decorated, data) {
                    ...
                    this.$selection.find('.jpselect2-selection__rendered')
                ...
                Search.prototype.resizeSearch = function () {
                    ...
                    if (this.$search.attr('placeholder') !== '') {
                        width = this.$selection.find('.jpselect2-selection__rendered').innerWidth();
                    } else {
            ...
            S2.define('jpselect2/selection/eventRelay',[
                'jquery'
            ], function ($) {
                function EventRelay () { }
            ...
            S2.define('jpselect2/translation',[
                'jquery',
                'require'
            ], function ($, require) {
            ...
            S2.define('jpselect2/diacritics',[
            ...
            S2.define('jpselect2/data/select',[
                './base',
                '../utils',
                'jquery'
            ...
            S2.define('jpselect2/data/array',[
                './select',
                '../utils',
                'jquery'
            ...
            S2.define('jpselect2/data/tags',[
                ...
                Tags.prototype.query = function (decorated, params, callback) {
                    ...
                    function wrapper (obj, child) {
                        ...
                        if (tag != null) {
                            ...
                            $option.attr('data-jpselect2-tag', true);
                ...
                Tags.prototype._removeOldTags = function (_) {
                    ...
                    var $options = this.$element.find('option[data-jpselect2-tag]');
            ...
            S2.define('jpselect2/data/tokenizer',[
                'jquery'
            ], function ($) {
                ...
                Tokenizer.prototype.bind = function (decorated, container, $container) {
                    ...
                    this.$search =  container.dropdown.$search || container.selection.$search ||
                        $container.find('.jpselect2-search__field');
                };
            ...
            S2.define('jpselect2/data/minimumInputLength',[
            ...
            S2.define('jpselect2/data/maximumInputLength',[
            ...
            S2.define('jpselect2/data/maximumSelectionLength',[
            ...
            S2.define('jpselect2/dropdown',[
                ...
                Dropdown.prototype.render = function () {
                    var $dropdown = $(
                        '<span class="jpselect2-dropdown">' +
                        '<span class="jpselect2-results"></span>' +
                        '</span>'
                    );
            ...
            S2.define('jpselect2/dropdown/search',[
                'jquery',
                '../utils'
            ], function ($, Utils) {
                function Search () { }
                ...
                Search.prototype.render = function (decorated) {
                    ...
                    var $search = $(
                        '<span class="jpselect2-search jpselect2-search--dropdown">' +
                        '<input class="jpselect2-search__field" type="search" tabindex="-1"' +
                        ' autocomplete="off" autocorrect="off" autocapitalize="off"' +
                ...
                Search.prototype.bind = function (decorated, container, $container) {
                    ...
                    container.on('results:all', function (params) {
                        if (params.query.term == null || params.query.term === '') {
                            ...
                            if (showSearch) {
                                self.$searchContainer.removeClass('jpselect2-search--hide');
                            } else {
                                self.$searchContainer.addClass('jpselect2-search--hide');
                            }
                        }
                    });
                };
            ...
            S2.define('jpselect2/dropdown/hidePlaceholder',[
            ...
            S2.define('jpselect2/dropdown/infiniteScroll',[
                'jquery'
            ], function ($) {
                ...
                InfiniteScroll.prototype.createLoadingMore = function () {
                    var $option = $(
                        '<li ' +
                        'class="jpselect2-results__option jpselect2-results__option--load-more"' +
            ...
            S2.define('jpselect2/dropdown/attachBody',[
                'jquery',
                '../utils'
            ], function ($, Utils) {
                ...
                AttachBody.prototype.position = function (decorated, $dropdown, $container) {
                    ...
                    $dropdown.removeClass('jpselect2');
                    $dropdown.addClass('jpselect2-container--open');
                ...
                AttachBody.prototype._attachPositioningHandler =
                    function (decorated, container) {
                        ...
                        var scrollEvent = 'scroll.jpselect2.' + container.id;
                        var resizeEvent = 'resize.jpselect2.' + container.id;
                        var orientationEvent = 'orientationchange.jpselect2.' + container.id;

                        var $watchers = this.$container.parents().filter(Utils.hasScroll);
                        $watchers.each(function () {
                            $(this).data('jpselect2-scroll-position', {
                                x: $(this).scrollLeft(),
                                y: $(this).scrollTop()
                            });
                        });
                        ...
                        $watchers.on(scrollEvent, function (ev) {
                            var position = $(this).data('jpselect2-scroll-position');
                ...
                AttachBody.prototype._positionDropdown = function () {
                    ...
                    var isCurrentlyAbove = this.$dropdown.hasClass('jpselect2-dropdown--above');
                    var isCurrentlyBelow = this.$dropdown.hasClass('jpselect2-dropdown--below');
                    ...
                    if (newDirection != null) {
                        this.$dropdown
                            .removeClass('jpselect2-dropdown--below jpselect2-dropdown--above')
                            .addClass('jpselect2-dropdown--' + newDirection);
                        this.$container
                            .removeClass('jpselect2-container--below jpselect2-container--above')
                            .addClass('jpselect2-container--' + newDirection);
                    }
            ...
            S2.define('jpselect2/dropdown/minimumResultsForSearch',[
            ...
            S2.define('jpselect2/dropdown/selectOnClose',[
            ...
            S2.define('jpselect2/dropdown/closeOnSelect',[
            ...
            S2.define('jpselect2/i18n/en',[],function () {
                // English
                return {
            ...
            S2.define('jpselect2/options',[
                ...
                Options.prototype.fromElement = function ($e) {
                    ...
                    if ($e.data('jpselect2Tags')) {
                        if (this.options.debug && window.console && console.warn) {
                            console.warn(
                                'Select2: The `data-jpselect2-tags` attribute has been changed to ' +
                                'use the `data-data` and `data-tags="true"` attributes and will be ' +
                                'removed in future versions of Select2.'
                            );
                        }

                        $e.data('data', $e.data('jpselect2Tags'));
                        $e.data('tags', true);
                    }
            ...
            S2.define('jpselect2/core',[
                ...
                var Select2 = function ($element, options) {
                    if ($element.data('jpselect2') != null) {
                        $element.data('jpselect2').destroy();
                    }
                    ...
                    $element.addClass('jpselect2-hidden-accessible');
                    $element.attr('aria-hidden', 'true');

                    // Synchronize any monitored attributes
                    this._syncAttributes();

                    $element.data('jpselect2', this);
                };
                ...
                Select2.prototype._registerDomEvents = function () {
                    ...
                    this.$element.on('change.jpselect2', function () {
                ...
                Select2.prototype._registerEvents = function () {
                    ...
                    this.on('open', function () {
                        self.$container.addClass('jpselect2-container--open');
                    });

                    this.on('close', function () {
                        self.$container.removeClass('jpselect2-container--open');
                    });

                    this.on('enable', function () {
                        self.$container.removeClass('jpselect2-container--disabled');
                    });

                    this.on('disable', function () {
                        self.$container.addClass('jpselect2-container--disabled');
                    });

                    this.on('blur', function () {
                        self.$container.removeClass('jpselect2-container--focus');
                    });
                ...
                Select2.prototype.isOpen = function () {
                    return this.$container.hasClass('jpselect2-container--open');
                };

                Select2.prototype.hasFocus = function () {
                    return this.$container.hasClass('jpselect2-container--focus');
                };
                ...
                Select2.prototype.focus = function (data) {
                    ...
                    this.$container.addClass('jpselect2-container--focus');
                    this.trigger('focus', {});
                };
                ...
                Select2.prototype.enable = function (args) {
                    if (this.options.get('debug') && window.console && console.warn) {
                        console.warn(
                            'Select2: The `jpselect2("enable")` method has been deprecated and will' +
                ...
                Select2.prototype.data = function () {
                    if (this.options.get('debug') &&
                        ...
                        console.warn(
                            'Select2: Data can no longer be set using `jpselect2("data")`. You ' +
                ...
                Select2.prototype.val = function (args) {
                    if (this.options.get('debug') && window.console && console.warn) {
                        console.warn(
                            'Select2: The `jpselect2("val")` method has been deprecated and will be' +
                ...
                Select2.prototype.destroy = function () {
                    ...
                    this.$element.off('.jpselect2');
                    this.$element.attr('tabindex', this.$element.data('old-tabindex'));

                    this.$element.removeClass('jpselect2-hidden-accessible');
                    this.$element.attr('aria-hidden', 'false');
                    this.$element.removeData('jpselect2');
                ...
                Select2.prototype.render = function () {
                    var $container = $(
                        '<span class="jpselect2 jpselect2-container">' +
                    ...
                    this.$container.addClass('jpselect2-container--' + this.options.get('theme'));
            ...
            S2.define('jpselect2/compat/utils',[
                'jquery'
            ], function ($) {
            ...
            S2.define('jpselect2/compat/containerCss',[
                'jquery',
                './utils'
            ...
            S2.define('jpselect2/compat/dropdownCss',[
                'jquery',
                './utils'
            ], function ($, CompatUtils) {
                // No-op CSS adapter that discards all classes by default
            ...
            S2.define('jpselect2/compat/initSelection',[
                'jquery'
            ], function ($) {
            ...
            S2.define('jpselect2/compat/inputData',[
                'jquery'
            ], function ($) {
            ...
            S2.define('jpselect2/compat/matcher',[
                'jquery'
            ], function ($) {
            ...
            S2.define('jpselect2/compat/query',[
            ...
            S2.define('jpselect2/dropdown/attachContainer',[
                ...
                AttachContainer.prototype.position =
                    function (decorated, $dropdown, $container) {
                        ...
                        $dropdown.addClass('jpselect2-dropdown--below');
                        $container.addClass('jpselect2-container--below');
                    };

                return AttachContainer;
            });

            S2.define('jpselect2/dropdown/stopPropagation',[
            ...
            S2.define('jpselect2/selection/stopPropagation',[
            ...
            S2.define('jquery.jpselect2',[
                ...
                if ($.fn.jpselect2 == null) {
                    ...
                    $.fn.jpselect2 = function (options) {
                        ...
                        if (typeof options === 'object') {
                            ...
                            this.each(function () {
                                var instance = $(this).data('jpselect2');

                                if (instance == null && window.console && console.error) {
                                    console.error(
                                        'The jpselect2(\'' + options + '\') method was called on an ' +
                ...
                if ($.fn.jpselect2.defaults == null) {
                    $.fn.jpselect2.defaults = Defaults;
                }
    ...
    var jpselect2 = S2.require('jquery.jpselect2');

    // Hold the AMD module references on the jQuery function that was just loaded
    // This allows Select2 to use the internal loader outside of this file, such
    // as in the language files.
    jQuery.fn.jpselect2.amd = S2;
