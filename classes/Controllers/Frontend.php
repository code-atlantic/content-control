...
class Frontend extends Controller {
	...
	public function hooks() {
		add_filter( 'content_control/feed_restricted_message', '\ContentControl\append_post_excerpts', 10, 2 );
		...
		add_filter( 'content_control/post_restricted_message', '\ContentControl\append_post_excerpts', 10, 2 );
